...
const LocalGuide: FC = () => {
    const { filteredServices, loading, error } = useFilteredServices("local guide");
    ...
    return (
        <div className="w-full min-h-screen bg-gradient-to-l from-amber-700 to-amber-400 p-8 flex flex-col items-center text-white">
            <h1 className="text-4xl md:text-6xl font-bold mb-8">Local Guide Services</h1>
            ...
            <TestimonialSlider filter="local guide" />
        </div>
    );
};
